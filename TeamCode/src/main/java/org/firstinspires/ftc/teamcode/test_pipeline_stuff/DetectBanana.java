...
import org.firstinspires.ftc.teamcode.test_pipeline_stuff.ACustomPipeline;
...
/**
* TestDetectBanana class.
*
* <p>An OpenCV pipeline generated by GRIP.
*
* @author GRIP
*/
public class DetectBanana extends ACustomPipeline {
	...
	public void process(Mat source0) {
		...
		double blurRadius = 6.3488016318205025;
		blur(blurInput, blurType, blurRadius, blurOutput);

		// Step HSV_Threshold0:
		Mat hsvThresholdInput = blurOutput;
		double[] hsvThresholdHue = {0.0, 96.57754010695186};
		double[] hsvThresholdSaturation = {0.28940172577058565, 152.33614029793284};
		double[] hsvThresholdValue = {144.0677966101695, 236.8181818181818};
	...
	@Override
	// process pipeline, return mask image as its the best to look at
	...
	public ElementPosition lastDetectedPosition() {
		...
		// TODO: should work like this, otherwise use 320 * .5 = 160
		if (xAvg > this.cvCvtcolorOutput.size().width / 2) {
